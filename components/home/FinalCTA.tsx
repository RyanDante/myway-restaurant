...
export function FinalCTA() {
  ...
  return (
    <section ref={container} className="relative w-full bg-[#0a0a0a] py-40 border-t border-neutral-900 overflow-hidden flex flex-col items-center justify-center">
      
      {/* Background massive text overlay (faint) */}
      <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none overflow-hidden">
        <h2 className="text-[20vw] font-black uppercase text-white whitespace-nowrap">MYWAY</h2>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="w-24 h-24 md:w-32 md:h-32 rotating-badge-bottom flex items-center justify-center mb-8">
          <svg viewBox="0 0 100 100" className="w-full h-full text-gold-500 fill-current">
            <path id="circlePathBottom" d="M 50, 50 m -37, 0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" fill="transparent" />
