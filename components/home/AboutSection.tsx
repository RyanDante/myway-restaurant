...
export function AboutSection() {
  ...
  return (
    <section ref={container} className="w-full bg-[#111111] py-32 overflow-hidden border-y border-neutral-900">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        <div className="w-full h-[50vh] md:h-[70vh] relative overflow-hidden rounded-sm border border-neutral-800">
          <Image 
            ...
            fill 
            className="object-cover scale-125" // Scale up to allow room for parallax
          />
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
            <button className="bg-gold-500 hover:bg-gold-400 text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest text-sm transition-transform duration-300 hover:scale-105 shadow-xl flex items-center gap-3">
              About Us
              <span className="w-6 h-6 bg-white rounded-full flex items-center justify-center text-black text-xs font-serif italic">i</span>
            </button>
          </div>
        </div>
        ...
        <div className="stats-container w-full mt-24 flex flex-col md:flex-row justify-between items-center text-left gap-12 border-t border-neutral-800 pt-16">
          ...
          <div className="flex gap-16">
            <div className="stat-box flex items-center gap-4">
              <span className="text-5xl md:text-6xl font-black text-white">+1K</span>
              <span className="text-sm font-bold uppercase tracking-widest text-gold-500 max-w-[80px]">Premium Wines</span>
            </div>
            
            <div className="w-px h-16 bg-neutral-800 hidden md:block"></div>
            
            <div className="stat-box flex items-center gap-4">
              <span className="text-5xl md:text-6xl font-black text-white">100<span className="text-3xl">%</span></span>
              <span className="text-sm font-bold uppercase tracking-widest text-gold-500 max-w-[80px]">Quality Foods</span>
            </div>
          </div>
        </div>
